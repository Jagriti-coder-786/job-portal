...
export default function KanbanColumn({ id, title, items, onScheduleInterview }) {
  ...
  return (
    <div className="flex flex-col min-w-[320px] w-[320px] bg-slate-50 dark:bg-slate-800/50 rounded-xl flex-shrink-0 border border-slate-200 dark:border-slate-700">
      <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-100/50 dark:bg-slate-800 rounded-t-xl">
